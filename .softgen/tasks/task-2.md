...
## Checklist
- [x] Create PrintJobForm component with metadata fields (session_print, session_name, date_created, select_temp, rfid_enable)
- [x] Add dynamic label list with add/remove functionality (name, prod_code, serial, epc)
- [x] Generate JSON preview from form data
- [x] Submit button to call API endpoint (POST /api/integration/create_print_job)
- [x] Display API response (respcode, errmsg, print_job_id)
